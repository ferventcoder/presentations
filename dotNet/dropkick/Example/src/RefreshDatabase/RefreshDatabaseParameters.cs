...
namespace RefreshDatabase
{
    ...
    public static class RefreshDatabaseParameters
    {
        ...
        /// </summary>
        public static string MigrationsAssemblyPath = @".\DropkickExample.dll";
        ...
        public static class Database
        {
            ...
            /// </summary>
            public static string Name = "DropkickExample";
            /// <summary>
